...
from org.gvsig.geoprocess.lib.sextante.dataObjects import FlyrVectIVectorLayer
...
def testRunShiftXY(geoprocess):
  ...
  r = geoprocess.execute("perturbatepointslayer", LAYER = currentLayer(),MEAN = 10000, STDDEV = 10000 )
  view = currentView()
  for value in r.values():
    print value, value.getDataStore().getFullName()
    loadShapeFile(str(value.getDataStore().getFullName()))
